...
public class CommandOpenProductDetails implements ICommand {

    private static final Logger log = Logger.getLogger(CommandOpenProductDetails.class);
    ...
    public ExecutionResult execute(SessionRequestContent content) {
        ...
        try {
            ...
            result.setPage(config.getPage("productDetails"));
        } catch (Exception e) {
            log.error(e);
